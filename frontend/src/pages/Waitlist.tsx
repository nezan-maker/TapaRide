...
import { Users, Zap, BellRing, Ticket, AlertCircle, ChevronRight } from 'lucide-react'
        ...
        <div className="mx-auto max-w-md">
          ...
          {!journeyId && (
            <div className="card p-6 text-center text-ink-400 text-sm">
              <Users className="mx-auto h-8 w-8 text-ink-200 mb-2" />
      ...
      <div className="p-5 space-y-4">
        {joined ? (
          <>
            ...
            >
              Simulate: Seat opened <ChevronRight className="h-4 w-4" />
            </button>
          </>
        ) : (
          <>
    ...
    <div className="card p-6 text-center animate-fade-in">
      ...
      <div className="mt-6 flex gap-3 justify-center">
        <Link to="/booking" className="btn-primary">
          <Ticket className="h-4 w-4" /> Claim Seat
        </Link>
