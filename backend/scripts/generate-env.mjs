...
const vars = [
  ...
  // ── RURA (external agency verification) ────────────────────────────────────
  { key: 'RURA_API_KEY',       kind: 'generate', bytes: 24,              desc: 'API key for RURA verification service' },
  { key: 'RURA_API_URL',       kind: 'input',                            desc: 'RURA verification API base URL' },
